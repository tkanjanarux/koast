...
var questions = [
...

  {
    type: 'confirm',
    name: 'gulp',
    message: 'Include default gulpfile',
    default: true
  },
...
exports.seed = function() {
  ...
  inquirer.prompt(questions, function(answers) {
    ...
    function writeJsonFromGenerator(path, generator) {
      var data = generator(answers);
      writeObjectToFile(path, data);
    }
    ...
    if(answers.gulp) {
      var gulpfile = [__dirname + '/templates/gulpfile.js'];
      writeToDest(gulpfile, './');
    }

    writeToDest([__dirname + '/templates/.gitignore', __dirname + '/templates/.jsbeautifyrc',__dirname + '/templates/.jshintrc'],'./');
