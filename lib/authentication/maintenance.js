...
function addSessionHandling(secrets, app) {
  ...
  passport.serializeUser(function (user, done) {
    done(null, { data: user, isAuthenticated : true, meta: {} });
  });
  ...
  if (authConfig && authConfig.maintenance === 'cookie') {
    ...
    log.warn(
      'Invalid "maintenance" option in authentication configuration:', (
        authConfig) ? authConfig.maintenance : 'undefined',
